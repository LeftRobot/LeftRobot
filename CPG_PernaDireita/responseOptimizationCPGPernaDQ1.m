function [Optimized_varsQ1, Info] = responseOptimizationCPGPernaDQ1(varsQ1)
%RESPONSEOPTIMIZATIONCPGPERNADIREITA
%
% Solve a design optimization problem for the CPGPernaDireita model.
%
% The function returns optimized parameter values, Optimized_varsQ1,
% and optimization termination information, Info.
%
% The input argument, varsQ1, defines the model parameters to optimize,
...
%
% Auto-generated by SDOTOOL on 06-Apr-2022 23:30:40.
%
...
if nargin < 1 || isempty(varsQ1)
    varsQ1 = sdo.getParameterFromModel('CPGPernaDireita',{'S1','b1','tr1','ta1','tr2','ta2','w12','w13','w21','w24'});
    varsQ1(1).Minimum = 0;
    varsQ1(2).Minimum = 0;
    varsQ1(2).Scale = 16;
    varsQ1(3).Minimum = 0;
    varsQ1(4).Minimum = 0;
    varsQ1(4).Scale = 0.0625;
    varsQ1(5).Minimum = 0;
    varsQ1(5).Scale = 0.125;
    varsQ1(6).Minimum = 0;
    varsQ1(6).Scale = 32;
    varsQ1(7).Maximum = 0;
    varsQ1(8).Maximum = 0;
...
Requirements = struct;
Requirements.track_oscQ1 = sdo.requirements.SignalTracking(...
    'ReferenceSignal', getData('track_oscQ1_ReferenceSignal'), ...
    'RobustCost', 'on', ...
    'Weights', getData('track_oscQ1_Weights'), 'Type','==');
...
ref_oscQ1_Info = Simulink.SimulationData.SignalLoggingInfo;
ref_oscQ1_Info.BlockPath = 'CPGPernaDireita/Add1';
ref_oscQ1_Info.LoggingInfo.LoggingName = 'ref_oscQ1';
ref_oscQ1_Info.LoggingInfo.NameMode = 1;

Simulator.LoggingInfo.Signals = ref_oscQ1_Info;
...
Options.MethodOptions.Algorithm = 'sqp';
...
[Optimized_varsQ1,Info] = sdo.optimize(optimfcn,varsQ1,Options);

%% Update Model
%
% Update the model with the optimized parameter values.
sdo.setValueInModel('CPGPernaDireita',Optimized_varsQ1);
end
...
ref_oscQ1_Log = find(SimLog,'ref_oscQ1');

% Evaluate the design requirements.
F_track_oscQ1 = evalRequirement(Requirements.track_oscQ1,ref_oscQ1_Log.Values);

%% Return Values.
%
% Collect the evaluated design requirement values in a structure to
% return to the optimization solver.
Vals.F = F_track_oscQ1;
end
...
switch DataID
    case 'track_oscQ1_ReferenceSignal'
