function [Optimized_DesignVars, Info] = responseOptimizationCPGPernaDireita(DesignVars)
...
%
% Auto-generated by SDOTOOL on 03-Apr-2022 18:41:10.
%
...
if nargin < 1 || isempty(DesignVars)
    DesignVars = sdo.getParameterFromModel('CPGPernaDireita',{'S1','b1','tr1','ta1','tr2','ta2','w12','w13','w21','w24'});
    ...
    DesignVars(7).Maximum = 302.7585710945252;
    DesignVars(8).Maximum = 0;
    DesignVars(9).Maximum = 0;
end
...
Requirements = struct;
Requirements.ref_oscQD1 = sdo.requirements.SignalTracking(...
    'ReferenceSignal', getData('ref_oscQD1_ReferenceSignal'), ...
    'RobustCost', 'on', ...
    'Weights', getData('ref_oscQD1_Weights'));
...
F_ref_oscQD1 = evalRequirement(Requirements.ref_oscQD1,oscQD1_Log.Values);
...
switch DataID
    case 'ref_oscQD1_ReferenceSignal'
