...
elseif (exist('torques_V1')==1 && velocidade==1)
    ...
    save('TORQUES_V1_SemCont.mat','timeV1','torqueV1');
...
elseif (exist('torques_V2')==1 && velocidade==2)
    ...
    save('TORQUES_V2_SemCont.mat','timeV2','torqueV2');
...
elseif (exist('torques_V3')==1 && velocidade==3)
    ...
    save('TORQUES_V3_SemCont.mat','timeV3','torqueV3');
...
elseif (exist('torques_V4')==1 && velocidade==4)
    ...
    save('TORQUES_V4_SemCont.mat','timeV4','torqueV4');
...
V1_torques = load('TORQUES_V1_SemCont.mat');
V2_torques = load('TORQUES_V2_SemCont.mat');
V3_torques = load('TORQUES_V3_SemCont.mat');
V4_torques = load('TORQUES_V4_SemCont.mat');
